...
Beim Anklicken eines Spielerkopfes oder beim Suchen nach einem Spieler wird eine Übersicht über den Spieler geöffnet. Du siehst direkt den Spielernamen, die höchste Gruppe und ein paar weitere Knöpfe, welche unten näher erläutert werden.
