...
Es gibt eine [Maximalanzahl](boosts.mdx#welche-boost-level-geben-welche-vorteile) von Plug-Ins, die auf deinem Realm installiert sein können. Diese Anzahl variiert je nach Boost-Level. System-Plug-Ins zählen nicht zu dieser Anzahl.

#### System-Plug-Ins

 - [PacketListenerAPI (modifizierte Version von Cytooxien)](https://github.com/Cytooxien/PacketListenerAPI)
 - [ViaVersion](https://modrinth.com/plugin/viaversion)
 - [ViaBackwards](https://modrinth.com/plugin/viabackwards)
 - [ProtocolLib](https://www.spigotmc.org/resources/protocollib.1997/)
 - [Realms-API (offizielle API um mit Realms zu interagieren)](https://github.com/Cytooxien/Realms-API/)

Es gibt weitere System-Plug-Ins, diese sind allerdings nicht sichtbar.
