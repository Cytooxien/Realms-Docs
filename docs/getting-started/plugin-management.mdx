...
There's a [maximum](boosts.mdx#what-do-realm-boosts-give-to-a-realm) allowed number of plugins which you can install on your realm. It is determined by the boost level of the realm. System plugins are excluded from it.

#### System plugins

- [PacketListenerAPI (modified version by Cytooxien)](https://github.com/Cytooxien/PacketListenerAPI)
- [ViaVersion](https://modrinth.com/plugin/viaversion)
- [ViaBackwards](https://modrinth.com/plugin/viabackwards)
- [ProtocolLib](https://www.spigotmc.org/resources/protocollib.1997/)
- [Realms-API (official API to interact with Realms)](https://github.com/Cytooxien/Realms-API/)

There are more plugins used, but they're not visible.
