...
**How to load a backup while on your Realm:**
    1. Use the `/realm` command to open the [realm menu](../getting-started/settings).
...
**How to load a backup while you're in the lobby**
    ...
    1. Open the Navigator and teleport to the [realm lobby](../getting-started/realm-lobby).
